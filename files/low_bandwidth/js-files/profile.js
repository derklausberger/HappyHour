...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    randomCocktails.id = "profileHead";
    ...
    .then(cocktails => {
        ...
        let change = document.getElementById("profileHead");
        change.innerHTML = "YOUR LIKED COCKTAILS";
        ...
        for (let cocktail of Array.from(cocktails)) {
                ...
                a.innerHTML = "Click here for der Recipe";
